...
const Home = () => {
  return (
    <>
      <div className="bg-home-section-1">
        <div className="py-10 px-6 sm:px-10 sm:container sm:mx-auto lg:container lg:mx-auto">
          ...
          <section className="mt-24 sm:mt-28 lg:flex lg:justify-between lg:items-end lg:mb-48">
      ...
      <div className="bg-home-section-2 bg-sacramento-state-green">
        <div className="py-16 sm:py-24 px-6 sm:px-10 sm:container sm:mx-auto lg:container lg:mx-auto">
          <div className="lg:flex lg:justify-between pt-9">
            <div className="relative">
              ...
              <h2 className="text-[32px] font-bold mb-14 w-2/3 pt-12">
      ...
      <div className="bg-home-section-3">
      ...
      <div className="bg-home-section-4 bg-secondary">
      ...
      <div className="bg-dark-green">
        <div className="py-16 sm:py-16 px-6 sm:px-10 sm:container sm:mx-auto lg:container lg:mx-auto">
